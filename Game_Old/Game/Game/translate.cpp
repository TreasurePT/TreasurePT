...
void CTranslate::SetTexts( )
{
	...
	DumpTranslate( 0x0098, "Personagens masculinos não podem usar este item" );
	DumpTranslate( 0x0098, "Personagens femininos não podem usar este item" );
	DumpTranslate( 0x0098, "Personagens femininos não podem pegar este item" );
	DumpTranslate( 0x0098, "Personagens masculinos não podem pegar este item" );
	DumpTranslate( 0x0098, "O preço do item foi alterado" );
	DumpTranslate( 0x0098, "Não há Ouro para retirar" );
	DumpTranslate( 0x0098, "Você não pode usar essa Força Orb" );
